  ...
  data() {
    return {
      ...
      categories: [
        ...
        { name: "Books, Music, Movies & Games", code: "books_music_movies_games" },
        { name: "Clothing & Accessories", code: "fashion" },
        { name: "Home & Garden", code: "beauty" },
        { name: "Beauty & Personal Care", code: "toys" },
        { name: "Health & Household", code: "tools" },
        { name: "Grocery & Gourmet Food", code: "sports" },
        { name: "Toys, Hobbies & Collectibles", code: "health" },
        { name: "Sports & Outdoors", code: "books" },
        { name: "Automotive & Industrial", code: "automotive" },
        { name: "Pet Supplies", code: "appliances" },
        { name: "Office Supplies & Equipment", code: "furniture" },
        { name: "Digital Content & Software", code: "furniture" },
      ],
      statuses: [
