...
var _HotWallet = class _HotWallet {
  ...
  async signTransaction(tx, partialSign = true) {
    ...
    const signature = await this.signingKey.toRawKey().sign(HexBlob2(tx.getId()));
...
var HotSingleWallet = class {
  ...
  constructor(paymentSigningKey, networkId, provider, stakeSigningKey) {
    ...
    this.address = this.address = new Address3({
      type: AddressType2.EnterpriseKey,
      networkId: this.networkId,
      paymentPart: {
        type: CredentialType2.KeyHash,
        hash: blake2b_224(HexBlob3(this.paymentPublicKey.hex()))
      },
      delegationPart: this.stakePublicKey ? {
        type: CredentialType2.KeyHash,
        hash: blake2b_224(HexBlob3(this.stakePublicKey.hex()))
      } : void 0
    });
    this.provider = provider;
  }
  ...
  async signTransaction(tx, partialSign = true) {
    ...
    const signature = signMessage(HexBlob3(tx.getId()), this.paymentSigningKey);
