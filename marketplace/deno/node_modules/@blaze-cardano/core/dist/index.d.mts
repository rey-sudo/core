...
declare const TxCBOR: {
    (tx: string): C.TxCBOR;
    serialize(tx: C.Cardano.Tx): C.TxCBOR;
    deserialize(tx: C.TxCBOR): C.Cardano.Tx;
};
type TxCBOR = C.TxCBOR;
declare const TransactionId: {
    ...
    fromTxBodyCbor(bodyCbor: C.TxBodyCBOR): C.Cardano.TransactionId;
};
...
declare const AssetId: {
    ...
    getAssetNameAsText(id: C.Cardano.AssetId): string;
};
...
export { Address, AddressType, AssetId, AssetName, AuxiliaryData, Bip32PrivateKey, Bip32PrivateKeyHex, Bip32PublicKey, CborReader, CborReaderState, CborSet, CborWriter, Certificate, CertificateType, ConstrPlutusData, CostModel, type CostModels, Costmdls, Credential, type CredentialCore, CredentialType, Datum, DatumHash, DatumKind, Ed25519KeyHashHex, Ed25519PrivateExtendedKeyHex, Ed25519PrivateNormalKeyHex, Ed25519PublicKey, Ed25519PublicKeyHex, Ed25519Signature, Ed25519SignatureHex, type Evaluator, ExUnits, Hash, Hash28ByteBase16, Hash32ByteBase16, HashAsPubKeyHex, Metadata, Metadatum, MetadatumList, MetadatumMap, NativeScript, NetworkId, PaymentAddress, PlutusData, PlutusDataKind, PlutusLanguageVersion, PlutusList, PlutusMap, PlutusV1Script, PlutusV2Script, PlutusV3Script, PolicyId, PolicyIdToHash, PoolId, type ProtocolParameters, Redeemer, RedeemerPurpose, RedeemerTag, Redeemers, RewardAccount, RewardAddress, SLOT_CONFIG_NETWORK, Script, type ScriptHash, Slot, type SlotConfig, StakeDelegation, type StakeDelegationCertificate, StakeRegistration, type TokenMap, Transaction, TransactionBody, TransactionId, TransactionInput, type TransactionInputSet, TransactionMetadatumKind, TransactionOutput, TransactionUnspentOutput, type TransactionWitnessPlutusData, TransactionWitnessSet, TxCBOR, Value, VkeyWitness, addressFromBech32, addressFromCredential, addressFromCredentials, addressFromValidator, blake2b_224, blake2b_256, derivePublicKey, entropyToMnemonic, fromHex, generateMnemonic, getPaymentAddress, hardCodedProtocolParams, mnemonicToEntropy, sha2_256, sha3_256, signMessage, toHex };
