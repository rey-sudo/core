...
var Blaze = class _Blaze {
  ...
  newTransaction() {
    return new import_tx.TxBuilder(this.params).addPreCompleteHook(async (tx) => {
      ...
      tx.setNetworkId(await this.wallet.getNetworkId()).addUnspentOutputs(myUtxos).setChangeAddress(changeAddress).useEvaluator((x, y) => this.provider.evaluateTransaction(x, y));
    });
  }
  /**
