...
// ../../node_modules/.pnpm/@cardano-ogmios+schema@6.5.0/node_modules/@cardano-ogmios/schema/dist/index.js
var require_dist = __commonJS({
  "../../node_modules/.pnpm/@cardano-ogmios+schema@6.5.0/node_modules/@cardano-ogmios/schema/dist/index.js"(exports) {
    "use strict";
...
// src/schema.ts
var schema_exports = {};
__reExport(schema_exports, __toESM(require_dist()));
...
var Ogmios = class _Ogmios {
      ...
      this.ws.on("message", (message) => {
        ...
        if (parsedMessage.id && parsedMessage.id in this.requests) {
          ...
          if (parsedMessage.error) {
            reject2(new Error(parsedMessage.error.message));
          } else {
  ...
  async evaluateTransaction(transaction, additionalUtxo) {
    return this.request("evaluateTransaction", { transaction, additionalUtxo });
  }
  // State Query API
...
export {
  ...
  unwrapped_exports as Unwrapped
};
