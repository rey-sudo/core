import { HexBlob, PlutusData, Script } from '@blaze-cardano/core';
import { Exact } from '@blaze-cardano/tx';
import { TArray } from '@sinclair/typebox';

type ScriptType = "Native" | "PlutusV1" | "PlutusV2";
/**
 ...
 */
declare function applyParamsToScript<T extends TArray>(plutusScript: string, params: Exact<T>, type: T): HexBlob;
/**
...
export { type ScriptType, applyParams, applyParamsToScript, cborToScript };
