...
create table if not exists orders(
  ...
  contract_0_utx varchar(100) default null,
  contract_1_utx varchar(100) default null,
  contract_2_utx varchar(100) default null,
  contract_3_utx varchar(100) default null,  
