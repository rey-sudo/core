...
var ConfigSchema = z.object({
  publicPath: z.string().optional().describe("The public path to the wasm files and the onnx model.").default(`file://${path.resolve(`node_modules/${package_default.name}/dist/`)}/`).refine((val) => isURI(val), {
