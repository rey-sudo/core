...
If the stock of the product is 15, only the 15 fastest people who express their intention to buy will be able to occupy a socket and secure a negotiation session.
The socket of a product is equal to the stock of a product, it is a concept that represents availability to open a trading session.
A trading session is defined as the process of trading a product for a limited time, the buyer and seller generate the negotiation context by engaging in bilateral communication.
