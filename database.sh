...
vtctldclient ApplySchema --sql-file="create_user_scheme.sql" service-sellers

vtctldclient ApplyVSchema --vschema-file="vschema_commerce_initial.json" service-sellers
