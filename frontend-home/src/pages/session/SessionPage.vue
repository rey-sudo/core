  ...
  <div class="session">
    ...
    <div class="session-wrap">
      <div class="session-head">
        ...
        <div class="session-body-left-timeline">
...
.session-head-top span:nth-child(1) {
  font-size: var(--text-size-f);
  font-weight: 600;
}

.session-head-top span:nth-child(2) {
