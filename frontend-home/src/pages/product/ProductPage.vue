<template>
  <div class="product">
    ...
    <div class="product-wrap">
      ...
      <div class="product-wrap-body">
        <Accordion :multiple="true" :activeIndex="[0]">
          <AccordionTab header="Description">
            <p class="accordionParagraph">
              Welcome to our cutting-edge e-commerce platform where innovation
              meets convenience! Step into the future of entertainment with the
              LG 65” Class UQ70 Series LED 4K UHD Smart webOS TV. Immerse
              yourself in the ultimate viewing experience with stunning 4K UHD
              resolution, bringing every detail to life with remarkable clarity
              and vivid colors. Whether you're watching your favorite movies,
              streaming the latest TV shows, or gaming with friends, this TV
              delivers breathtaking visuals that will captivate your senses.
              Featuring LG's webOS Smart platform, accessing your favorite
              content has never been easier. Navigate seamlessly through a world
              of entertainment with intuitive controls and a user-friendly
              ...
              something to enjoy for everyone in the family. With its sleek and
              modern design, the LG UQ70 Series TV effortlessly complements any
              living space, elevating your home entertainment setup to new
              heights. Its slim bezels and premium finish exude sophistication,
              making it a focal point in any room. But it's not just about
              looks—the LG UQ70 Series is packed with innovative features to
              enhance your viewing experience. From advanced image processing
              technologies for smoother motion to immersive audio capabilities
              that bring sound to life, every aspect is designed to provide you
              with unparalleled entertainment. Equipped with multiple HDMI and
              USB ports, connecting your favorite devices such as gaming
              consoles, Blu-ray players, and sound systems is a breeze, ensuring
              you have everything you need for a truly immersive entertainment
